...
| `github.com/eino-contrib/ollama` | v0.1.0 | Ollama 额外工具支持 |
...
| `github.com/nikolalohinski/gonja` | v1.5.3 | MCP 模板渲染 |
...
| `github.com/spf13/pflag` | v1.0.9 | 命令行标志解析 |
...
| 许可证 | 必须与 Apache 2.0 兼容（见 [Licensing](licensing.md)）|
| 大小 | 优先选择轻量级库 |
