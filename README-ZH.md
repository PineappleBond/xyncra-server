...
📖 完整场景分析：[docs/DESIGN_HITL_RESILIENCE.md](docs/DESIGN_HITL_RESILIENCE.md)

📖 Agent 配置详情：[docs/PRODUCT_DECISIONS.md](docs/PRODUCT_DECISIONS.md)（D-054 至 D-124）及 [docs/PRODUCT_DECISIONS_DETAILS.md](docs/PRODUCT_DECISIONS_DETAILS.md)
...
📖 设计理念：[docs/PRODUCT_DECISIONS.md](docs/PRODUCT_DECISIONS.md)（D-001 至 D-005）
...
| [产品决策](docs/PRODUCT_DECISIONS.md)                         | 架构决策（D-001 至 D-124，共定义 111 项）             |
| [产品决策详情](docs/PRODUCT_DECISIONS_DETAILS.md)             | 详细决策规格                                         |
| [开发者指南](docs/DEVELOPER_GUIDE.md)                         | 项目结构、编码规范、操作指南                         |
| [开发者参考](docs/DEVELOPER_REFERENCE.md)                     | 开发者参考文档                                       |
| [HITL 韧性设计](docs/DESIGN_HITL_RESILIENCE.md)               | HITL 故障场景、恢复矩阵、数据模型                    |
...
- 遵循现有的模式和命名规范（参见[开发者指南](docs/DEVELOPER_GUIDE.md)）
